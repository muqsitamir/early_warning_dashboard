...
export default function TopAppBar(){
    ...
    return (
        <header  style={{ background: 'whitesmoke' }} className="mdc-top-app-bar mdc-top-app-bar--shadow__ mdc-top-app-bar--fixed js-top-app-bar"
            ...
            <div className="mdc-top-app-bar__row contain-full-bleed links--muted ">
                <section className="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
                    ...
                    <Link to="/dashboard" className="mdc-top-app-bar__title">
